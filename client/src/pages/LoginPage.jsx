      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-card p-8 shadow-2xl shadow-indigo-500/20 border border-white/20 backdrop-blur-xl">
          ...
          <button
            ...
            className="w-full mb-6 py-3 px-4 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-xl border border-gray-300 shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-3"
          >
